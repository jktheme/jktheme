...
function(t, e) {
	...
	function m(t, e) { (null == e || e > t.length) && (e = t.length);
		for (var i = 0,
	...
	k = "undefined" != typeof window && window.ResizeObserver ||
	function() {
		function t(e) {
			o(this, t),
			this.observables = [],
		...
		},
		{
			...
			value: function() {
				var t = this.observables.filter((function(t) {
					...
					i = t.el.clientWidth;
					if (t.size.height !== e || t.size.width !== i) return t.size.height = e,
					t.size.width = i,
					!0
				})).map((function(t) {
					return t.el
	...
	T = function() {
		function t() {
			...
			this.events = {};
			for (var i = 0,
			n = ["on", "once"]; i < n.length; i++) for (var a = n[i], s = 0, r = Object.entries(this.options[a] || {}); s < r.length; s++) {
				var l = r[s];
		...
		},
		{
			...
			value: function(t, e) {
				...
				if (b(t)) {
					for (var n = 0,
					o = Object.entries(t); n < o.length; n++) {
						var a = o[n];
			...
			value: function(t, e) {
				...
				return String(t).split(" ").forEach((function(t) {
					var n = function n() {
						...
						a = new Array(o), s = 0; s < o; s++) a[s] = arguments[s];
		...
		},
		{
			...
			value: function(t) {
				for (var e = {},
				i = 0,
				n = Object.entries(t || {}); i < n.length; i++) {
					var o = v(n[i], 2),
					a = o[0],
					s = o[1]; ! 1 === this.options[a] || this.plugins[a] || (this.options[a] = x({},
					s.defaults || {},
					this.options[a]), e[a] = new s(this))
				}
				for (var r = 0,
				l = Object.entries(e); r < l.length; r++) {
					var c = v(l[r], 2);
					c[0],
					c[1].attach(this)
				}
				return this.plugins = Object.assign({},
				this.plugins, e),
				this
			}
		},
		{
			...
			value: function() {
				for (var t in this.plugins) {
					var e = void 0; (e = this.plugins[t]) && "function" == typeof e.detach && e.detach(this)
				}
				return this.plugins = {},
				this
			}
	...
	O = function(t) {
		...
		function n(t) {
			...
			i.$container = t;
			for (var s = 0,
			r = ["onLoad", "onWheel", "onClick"]; s < r.length; s++) {
				var l = r[s];
				i[l] = i[l].bind(d(i))
			}
			return i.initLayout(),
		...
		},
		{
			key: "onClick",
			value: function(t) {
				if (!t.defaultPrevented) if (this.option("textSelection") && window.getSelection().toString().length) t.stopPropagation();
				else {
					...
					void t.stopPropagation(); ! 1 !== this.trigger("click", t) && this.option("zoom") && "toggleZoom" === this.option("click") && (t.preventDefault(), t.stopPropagation(), this.zoomWithClick(t))
				}
			}
		},
		{
			key: "onWheel",
			value: function(t) { ! 1 !== this.trigger("wheel", t) && this.option("zoom") && this.option("wheel") && this.zoomWithWheel(t)
			}
		},
		{
			key: "zoomWithWheel",
			...
			value: function() {
				...
				var e = new P(this.$container, {
					start: function(i, n) {
						...
						if (! (t.velocity.scale < 0)) {
							if (!e.currentPointers.length) {
								...
								if (t.option("textSelection") &&
								function(t, e, i) {
									for (var n = t.childNodes,
									o = document.createRange(), a = 0; a < n.length; a++) {
										var s = n[a];
					...
					move: function(i, n, o) {
						...
						if ("pointerdown" === t.state) if (t._dragOffset = i({},
						t.dragOffset), e.currentPointers.length) t.resetDragPosition();
		...
		{
			key: "updateMetrics",
			value: function(t) { ! 0 !== t && this.trigger("beforeUpdate");
		...
		},
		{
			key: "setTransform",
			value: function(t) {
				var e, n, o, a, s; (t ? (e = w(this.transform.x), n = w(this.transform.y), o = this.transform.scale, this.content = i(i({},
				this.content), {},
				{
					x: e,
					y: n,
					scale: o
				})) : (e = w(this.content.x), n = w(this.content.y), o = this.content.scale / (this.content.width / this.content.fitWidth), this.content = i(i({},
				this.content), {},
				{
					x: e,
					y: n
				})), this.trigger("beforeTransform"), e = w(this.content.x), n = w(this.content.y), t && this.option("zoom")) ? (a = w(this.content.fitWidth * o), s = w(this.content.fitHeight * o), this.content.width = a, this.content.height = s, this.transform = i(i({},
				this.transform), {},
				{
					width: a,
					height: s,
	...
	N = function(t) {
		...
		function n(t) {
			var i, a = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
			if (o(this, n), a = x(!0, {},
			R, a), (i = e.call(this, a)).state = "init", i.$container = t, !(i.$container instanceof HTMLElement)) throw new Error("No root element provided");
		...
		},
		{
			...
			value: function() {
				...
				a = this.option("classNames"); (this.$viewport = this.option("viewport") || this.$container.querySelector(".".concat(o).concat(a.viewport)), this.$viewport) || (this.$viewport = document.createElement("div"), (t = this.$viewport.classList).add.apply(t, p((o + a.viewport).split(" "))), (e = this.$viewport).append.apply(e, p(this.$container.childNodes)), this.$container.appendChild(this.$viewport)); (this.$track = this.option("track") || this.$container.querySelector(".".concat(o).concat(a.track)), this.$track) || (this.$track = document.createElement("div"), (i = this.$track.classList).add.apply(i, p((o + a.track).split(" "))), (n = this.$track).append.apply(n, p(this.$viewport.childNodes)), this.$viewport.appendChild(this.$track))
			}
		},
		{
			key: "initSlides",
		...
		},
		{
			...
			value: function() {
				...
				d = 0,
				u = 0; u < this.slides.length; u += 1) {
					var f = this.slides[u]; (!r.length || d + f.width > a) && (r.push({
						indexes: [],
						slides: []
					}), h = r.length - 1, d = 0),
					d += f.width,
			...
			value: function() {
				...
				this.Panzoom.on({
					"*": function(e) {
						...
						n = new Array(i > 1 ? i - 1 : 0), o = 1; o < i; o++) n[o - 1] = arguments[o];
		...
		},
		{
			key: "updatePanzoom",
			value: function() {
				this.Panzoom && (this.Panzoom.content = i(i({},
		...
		},
		{
			...
			value: function() {
				...
				if (! (!this.option("infiniteX", this.option("infinite")) || this.pages.length < 2 || t < e)) {
					var i = this.Panzoom,
					n = !1;
					return i.content.x < -1 * (t - e) && (i.content.x += t, this.pageIndex = this.pageIndex - this.pages.length, n = !0),
		...
		},
		{
			...
			value: function(t, e) {
				...
				} else t = n = Math.max(0, Math.min(n, s - 1)),
	...
	X = function() {
		function t(e) {
			...
			for (var i = 0,
			n = ["onReady", "onResize", "onTouchstart", "onTouchmove"]; i < n.length; i++) {
				var a = n[i];
			...
			value: function(t) {
				...
				if (t.cancelable && !(t.touches.length > 1 || 1 !== i)) {
					...
					if (o) {
						...
						l = e <= r && 0 === o.scrollTop,
						c = e >= r && o.scrollHeight - o.scrollTop === s; (l || c) && t.preventDefault()
	...
	q = function() {
		function t(e) {
			...
			this.state = "init";
			for (var i = 0,
			n = ["onPrepare", "onClosing", "onKeydown"]; i < n.length; i++) {
				var a = n[i];
				this[a] = this[a].bind(this)
			}
			this.events = {
	...
	V = function() {
		function t(e) {
			...
			this.fancybox = e;
			for (var i = 0,
			n = ["onInit", "onReady", "onCreateSlide", "onRemoveSlide", "onSelectSlide", "onUnselectSlide", "onRefresh", "onMessage"]; i < n.length; i++) {
				var a = n[i];
				this[a] = this[a].bind(this)
			}
			this.events = {
		...
		},
		{
			...
			value: function(t) {
				...
				if (!e || "string" == typeof e) {
					...
					"html5video" !== i && "video" !== i || (t.video = x({},
					this.fancybox.option("Html.video"), t.video), t._width && t._height ? t.ratio = parseFloat(t._width) / parseFloat(t._height) : t.ratio = t.ratio || t.video.ratio || Y.video.ratio)
				}
			}
		},
		{
		...
		},
		{
			...
			value: function(t) {
				...
				if (n.className = "fancybox__iframe", n.setAttribute("id", "fancybox__iframe_".concat(i.id, "_").concat(t.index)), n.setAttribute("allow", "autoplay; fullscreen"), n.setAttribute("scrolling", "auto"), t.$iframe = n, "iframe" !== t.type || !1 === t.preload) return n.setAttribute("src", t.src),
	...
	var Z = function() {
		function t(e) {
			...
			this.fancybox = e;
			for (var i = 0,
			n = ["onReady", "onClosing", "onDone", "onPageChange", "onCreateSlide", "onRemoveSlide", "onImageStatusChange"]; i < n.length; i++) {
				var a = n[i];
				this[a] = this[a].bind(this)
			}
			this.events = {
	...
	var G = function() {
		function t(e) {
			...
			this.fancybox = e;
			for (var i = 0,
			n = ["onChange", "onClosing"]; i < n.length; i++) {
				var a = n[i];
				this[a] = this[a].bind(this)
			}
			this.events = {
			...
			value: function(t) {
				...
				s && a !== s && (this.timer = setTimeout((function() {
					try {
						...
						document.title, window.location.pathname + window.location.search + s),
		...
		},
		{
			...
			value: function(e) {
				...
				t.Fancybox = e,
				D && window.requestAnimationFrame((function() { / complete | interactive | loaded / .test(document.readyState) ? i() : document.addEventListener("DOMContentLoaded", i)
				}))
			}
		},
		{
...
Q = {
        display: ["counter", "download" , "zoom", "slideshow", "fullscreen", "thumbs", "close"],
        autoEnable:!0,
        items: {
            counter: {
                position: "left",
...
click: function (t) {
    t.preventDefault();
    var slide = this.fancybox.getSlide();
    if (slide && slide.src) {
        // 创建一个隐藏的a标签
        var a = document.createElement('a');
        a.href = slide.src;
        a.download = slide.src.split('/').pop();
    ...
    var tt = function () {
        ...
        return s(t, [{
            ...
            },
            {
                ...
                value: function () {
                    var t = this.fancybox;
                    if ("init" === this.state && (this.build(), this.update(), this.Slideshow = new J(t),!t.Carousel.prevPage && (t.option("slideshow.autoStart") && this.Slideshow.activate(), t.option("fullscreen.autoStart") &&!K.element()))) try {
            ...
            },
		{
			key: "createElement",
			value: function(t) {
				var e, i; ("div" === t.type ? e = document.createElement("div") : (e = document.createElement("link" === t.type ? "a": "button")).classList.add("carousel__button"), e.innerHTML = t.html, e.setAttribute("tabindex", t.tabindex || 0), t.class) && (i = e.classList).add.apply(i, p(t.class.split(" ")));
			...
			value: function() {
				...
				try {
					var s = function() {
						...
						r = void 0;
						if (b(a) ? (s = a.id, r = x({},
						i[s], a)) : r = i[s = a], ["counter", "next", "prev", "slideshow"].includes(s) && t.fancybox.items.length < 2) return "continue";
						if ("fullscreen" === s) {
	...
	at = function(t) {
		...
		return s(i, [{
			...
			value: function() {
				for (var t = 0,
				e = ["onMousedown", "onKeydown", "onClick", "onFocus", "onCreateSlide", "onSettle", "onTouchMove", "onTouchEnd", "onTransform"]; t < e.length; t++) {
					var i = e[t];
		...
		},
		{
			...
			value: function() {
				...
				this.id || (this.id = this.options.id || ++ot, this.$container.setAttribute("id", "fancybox-" + this.id));
			...
			value: function(t) {
				...
				try {
					for (n.s(); ! (e = n.n()).done;) {
						...
						o.$thumb = r || null;
						var c = o.thumb; ! c && r && !(c = r.currentSrc || r.src) && r.dataset && (c = r.dataset.lazySrc || r.dataset.src),
		...
		},
		{
			...
			value: function(t) {
				if (!t.defaultPrevented) {
					var e = t.target;
					if (e.matches("[data-fancybox-close]")) return t.preventDefault(),
					void i.close(!1, t);
					if (e.matches("[data-fancybox-next]")) return t.preventDefault(),
					void i.next();
					if (e.matches("[data-fancybox-prev]")) return t.preventDefault(),
					void i.prev();
		...
		},
		{
			...
			value: function(t) {
				if (! (i.ignoreFocusChange || ["init", "closing", "customClosing", "destroy"].indexOf(this.state) > -1)) {
					...
					for (var e, n = this.$container,
					o = this.getSlide(), a = "done" === o.state ? o.$el: null, s = [], r = 0, l = Array.from(n.querySelectorAll(W)); r < l.length; r++) {
						var c = l[r],
						h = c.offsetParent,
						d = a && a.contains(c),
		...
		},
		{
			...
			value: function(t, e) {
				...
				if (e instanceof HTMLElement)["img", "iframe", "video", "audio"].indexOf(e.nodeName.toLowerCase()) > -1 ? (i = document.createElement("div")).appendChild(e) : i = e;
					...
					var a = document.createRange().createContextualFragment(e); (i = document.createElement("div")).appendChild(a)
				}
		...
		},
		{
			...
			value: function(t) {
				var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
				n = function(t) {
					for (var e = ["false", "0", "no", "null", "undefined"], i = ["true", "1", "yes"], n = Object.assign({},
					t.dataset), o = {},
					a = 0, s = Object.entries(n); a < s.length; a++) {
						var r = v(s[a], 2),
						l = r[0],
						c = r[1];
						if ("fancybox" !== l) if ("width" === l || "height" === l) o["_".concat(l)] = c;
						else if ("string" == typeof c || c instanceof String) if (e.indexOf(c) > -1) o[l] = !1;
				...
				s = e.target || null,
				r = void 0 !== (e = x({},
				e, i.openers.get(t))).groupAll && e.groupAll,
				...
				var h = i.getInstance();
				return ! (h && o.indexOf(h.options.$trigger) > -1) && (a = s ? o.indexOf(s) : a, new i(o = o.map(n), x({},
				e, {
					startIndex: a,
					$trigger: s
				})))
		...
		},
		{
			...
			价值:功能(t){value: function(t) {
				return t ? nt.get(t) : Array.from(nt.values()).reverse().find((function(t) {return t ? nt.get(t) : Array.from(nt.values()).reverse().find((function(t) {
					return ! ["closing", "customClosing", "destroy"].includes(t.state) && treturn ! ["closing", "customClosing", "destroy"].includes(t.state) && t
				})) || null})) || null
			}}
		},},
		{{
			...
			value: function() {value: function() {
				var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0],var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0],
				e = arguments.length > 1 ? arguments[1] : void 0;e = arguments.length > 1 ? arguments[1] : void 0;
				如果(t){if (t) {
					var n, o = y(nt.values());var n, o = y(nt.values());
					试炼 {
						 为了  ( O. s ( ) ; ! ( n = o. n ( ) ) . 完成的 ; )  { 为了  ( O. s ( ) ; ! ( n = o. n ( ) ) . 完成的 ; )  {
							A=N值; Var  A = n. 价值 ;
							A. 关闭 ( e ) 接近的 ( e )
						}}
					 }  抓住 ( t )  {  }   抓住  ( t )   {
		...
		我
	        T
	在。 版本 = "4.0.22" ,version = "4.0.22" ,
	违约=它,defaults = it,
	打开者=新地图,openers = 新的 地图,
	波金斯=等等,Plugins = et,
	在。 绑紧         (        "[data-fancybox]"       ) ; 绑紧      (     "[data-fancybox]"    ) ;
	         ( 无价值 = 0 , 为了          ( Var  标准的 = 0 ,
	 机器人 = Object. 作品        ( 在。 普尔金斯 || {       }      ) ; st < rt. 长度 ; st++ )      { rt=物体。 作品    ( 在。 普尔金斯 || {   }  ) ; st < rt. 长度 ; st++ )  {
		 Var  中尉 = v        ( 机器人 [ 标准的 ] , 2        ) ; Var  中尉 = v        ( 机器人 [ 标准的 ] , 2        ) ;
		中尉 [        0        ] ; [       0      ] ;
		 Var  计算机技术 = [     1    ] ; Var  计算机技术 = [   1  ] ;
		 "功能" =C.. 创建和 ... 创建 ( 在…上 ) "function" == 类型 C. 创造 && ct. 创造 ( 在…上 )
	 } }
	t. 旋转木马 = N,Carousel = N,
	T形花箱=,Fancybox = at,
	T. 潘缩姆 =欧潘缩放=O
